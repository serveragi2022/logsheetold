...
Public Class crlogsheetrevise
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Logsheet.crlogsheetrevise.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedcrlogsheetrevise
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crlogsheetrevise = New crlogsheetrevise()
        rpt.Site = Me.Site
        Return rpt
    End Function
