...
Public Class confirmsupadmin
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        Try
            ...
            ElseIf Trim(txtpass.Text) = "" Then
                ...
                Exit Sub
            Else
                sql = "SELECT * from tblusers where status='1' and username='" & Trim(txtuser.Text) & "' and (department='All' or department='Admin Dispatching')"
                connect()
                ...
                If dr.Read Then
                    If (dr("workgroup").ToString.Contains("Administrator") = True And txtpass.Text = Decrypt(dr("password"))) Or (dr("workgroup") = "Manager" And txtpass.Text = Decrypt(dr("password"))) Or (dr("workgroup") = "Supervisor" And txtpass.Text = Decrypt(dr("password"))) Or (dr("department") = "Admin Dispatching" And txtpass.Text = Decrypt(dr("password"))) Then
                        orderfillreturn.ofretcnf = True
                        orderfillreturn.returnedby = dr("fullname")
                        Me.Close()
                        Exit Sub
                        'End If
                    End If
    ...
    Private Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button2.Click
        Me.Cursor = Cursors.Default
        orderfillreturn.ofretcnf = False
        orderfillreturn.returnedby = ""
