...
Public Class crorderfillnew
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Logsheet.crorderfillnew.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedcrorderfillnew
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crorderfillnew = New crorderfillnew()
        rpt.Site = Me.Site
        Return rpt
    End Function
