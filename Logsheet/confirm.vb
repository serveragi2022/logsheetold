...
Public Class confirm
            ...
            Else
                ...
                While dr.Read
                    If (dr("workgroup").ToString.Contains("Administrator") = True And txtpass.Text = Decrypt(dr("password"))) Or (dr("workgroup") = "Manager" And txtpass.Text = Decrypt(dr("password"))) Or (dr("workgroup") = "Supervisor" And txtpass.Text = Decrypt(dr("password"))) Or (dr("department") = "Admin Dispatching" And txtpass.Text = Decrypt(dr("password"))) Then
                        shift.shiftcnf = True
                        wgroup.wgroupcnf = True
                        login.bypass = True
                        whse.whsecnf = True
                        palletizer.linecnf = True
                        users.firm = True
                        items.firmitems = True
                        newitems.firmitems = True
                        category.catg = True
                        plocation.loccnf = True
                        ticket.ticketcnf = True
                        dept.deptcnf = True
                        'usersched.schedcnf = True
                        ticketcancel.cnlpallet = True
                        ticketcancel.cnlby = dr("fullname")
                        ticketsum.adlogcnf = True
                        ticketsum.adlogby = dr("fullname")
                        ...
                        palletsumcancel.palsumcnlcnf = True
                        reclogsheet.adlogcnf = True
                        reclogsheet.adlogby = dr("fullname")
    ...
    Private Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button2.Click
        Me.Cursor = Cursors.Default
        shift.shiftcnf = False
        wgroup.wgroupcnf = False
        login.bypass = False
        whse.whsecnf = False
        palletizer.linecnf = False
        users.firm = False
        items.firmitems = False
        newitems.firmitems = False
        category.catg = False
        plocation.loccnf = False
        ticket.ticketcnf = False
        dept.deptcnf = False
        'usersched.schedcnf = False
        ticketcancel.cnlpallet = False
        ticketsum.adlogcnf = False
        tlogcancel.logcnlcnf = False
        version.compscnf = False
        ticketsum.adlogcnf = False
        orderfill.ofcnf = False
        palletsumcancel.palsumcnlcnf = False
