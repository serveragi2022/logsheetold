...
Public Class crorderfillperitem
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Logsheet.crorderfillperitem.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedcrorderfillperitem
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crorderfillperitem = New crorderfillperitem()
        rpt.Site = Me.Site
        Return rpt
    End Function
