...
Public Class copyoforderfillpallets
    ...
    Private Sub orderfillpallets_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        ofcus = orderfill.txtcus.Text
        ofn = orderfill.lblorf.Text & orderfill.txtorf.Text
    End Sub
        ...
        Try
            ...
            Else
                ...
                For Each row As DataGridViewRow In grdselect.Rows
                    ...
                    sql = "Select Count(logdoubleid) from tbllogdouble where logsheetnum='" & lognum & "' and palletnum='" & grdselect.Rows(row.Index).Cells(3).Value & "' and status='1' and branch='" & login.branch & "'"
                    connect()
                    cmd = New SqlCommand(sql, conn)
    ...
    Private Sub btnsearch_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnsearch.Click
        Try
            ...
            sql = "Select tbllogticket.qadispo, tbllogticket.palletnum, tbllogitem.itemname from tbllogsheet"
            sql = sql & " inner join tbllogitem on tbllogsheet.logsheetnum=tbllogitem.logsheetnum"
            sql = sql & " inner join tbllogticket on tbllogitem.logitemid=tbllogticket.logitemid"
            sql = sql & " where tbllogsheet.logsheetdate='" & Format(datefrom.Value, "yyyy/MM/dd") & "' and tbllogsheet.status<>'3' and tbllogsheet.branch='" & login.branch & "'"
            ...
            m_addcmbtempDelegate = New AddcmbtempDelegate(AddressOf AddDGVcmbtemp)

            AddHandler bworkstat.DoWork, New DoWorkEventHandler(AddressOf bworkstat_DoWork)
            AddHandler bworkstat.RunWorkerCompleted, New RunWorkerCompletedEventHandler(AddressOf bworkstat_Completed)
            AddHandler bworkstat.ProgressChanged, New ProgressChangedEventHandler(AddressOf bworkstat_ProgressChanged)
    ...
    Private Sub bwork_DoWork(ByVal sender As Object, ByVal e As DoWorkEventArgs)
        ...
        While drx.Read
            If drx("qadispo") = 1 Then
                AddDGVcmbtemp(drx("palletnum"))
            End If
        End While
        drx.Dispose()
        cmd.Dispose()
    ...
    Delegate Sub AddcmbtempDelegate(ByVal value0 As Object)
    Private m_addcmbtempDelegate As AddcmbtempDelegate

    Private Sub AddDGVcmbtemp(ByVal v0 As String)
        If threadEnabled = True Then
            If cmbtemp.InvokeRequired Then
                cmbtemp.BeginInvoke(New AddcmbtempDelegate(AddressOf AddDGVcmbtemp), v0)
            Else
    ...
    Private Sub bworkstat_DoWork(ByVal sender As Object, ByVal e As DoWorkEventArgs)
        ...
        For Each item As Object In cmbtemp.Items
            sql = "Select * from tbllogticket where palletnum='" & item & "' and branch='" & loginbranch & "'"
            Dim connection As SqlConnection
            connection = New SqlConnection
            connection.ConnectionString = strconn
            If connection.State <> ConnectionState.Open Then
    ...
    Delegate Sub AddRowDelegate(ByVal value0 As Object, ByVal value1 As Object, ByVal value2 As Object, ByVal value3 As Object, ByVal value4 As Object, ByVal value5 As Object, ByVal value6 As Object, ByVal value7 As Object, ByVal value8 As Object, ByVal value9 As Object, ByVal value10 As Object, ByVal value11 As Object, ByVal value12 As Object, ByVal value13 As Object, ByVal value14 As Object, ByVal value15 As Object, ByVal valuerow As Object, ByVal colorrow As Object, ByVal onlyrow As Object)
    Private m_addRowDelegate As AddRowDelegate

    Private Sub AddDGVRow(ByVal v0 As Integer, ByVal v1 As Boolean, ByVal v2 As Date, ByVal v3 As String, ByVal v4 As String, ByVal v5 As String, ByVal v6 As Integer, ByVal v7 As String, ByVal v8 As String, ByVal v9 As String, ByVal v10 As String, ByVal v11 As String, ByVal v12 As String, ByVal v13 As String, ByVal v14 As String, ByVal v15 As String, ByVal vrow As Integer, ByVal colorrow As String, ByVal onlyrow As Boolean)
        If threadEnabled = True Then
            If grdpallets.InvokeRequired Then
                grdpallets.BeginInvoke(New AddRowDelegate(AddressOf AddDGVRow), v0, v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11, v12, v13, v14, v15, vrow, colorrow, onlyrow)
            Else
                grdpallets.Rows.Add(v0, v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11, v12, v13, v14, v15)
    ...
    Private Sub bworkcount_DoWork(ByVal sender As Object, ByVal e As DoWorkEventArgs)
        ...
        For Each row As DataGridViewRow In grdpallets.Rows
            'tblloggood no of available
            'sql = "Select Count(loggoodid) from tblloggood where palletnum='" & grdpallets.Rows(row.Index).Cells(5).Value & "' and status='1' and branch='" & loginbranch & "'"
            sql = "Select Count(loggoodid) from tblloggood where logticketid='" & grdpallets.Rows(row.Index).Cells(0).Value & "' and status='1' and branch='" & loginbranch & "'"
            Dim connection As SqlConnection
            connection = New SqlConnection
            connection.ConnectionString = strconn
            If connection.State <> ConnectionState.Open Then
            ...
            'tbllogdouble no of available
            sql = "Select Count(logdoubleid) from tbllogdouble where logticketid='" & grdpallets.Rows(row.Index).Cells(0).Value & "' and status='1' and branch='" & loginbranch & "'"
            connection = New SqlConnection
            connection.ConnectionString = strconn
            If connection.State <> ConnectionState.Open Then
                connection.Open()
            ...
            sql = "Select prodrems from tbllogsheet where logsheetnum='" & lognum & "' and branch='" & loginbranch & "'"
            connection = New SqlConnection
            connection.ConnectionString = strconn
            If connection.State <> ConnectionState.Open Then
                connection.Open()
            ...
            dr = cmd.ExecuteReader
            If dr.Read Then
                prems = dr("prodrems").ToString
            End If
            dr.Dispose()
            cmd.Dispose()
            connection.Close()

            AddDGVcount(totalgood + totaldouble, prems, i)

            i += 1
        Next
    End Sub

    Delegate Sub AddcountDelegate(ByVal value0 As Object, ByVal value1 As Object, ByVal vrow As Object)
    Private m_addcountDelegate As AddcountDelegate

    Private Sub AddDGVcount(ByVal v0 As Integer, ByVal v1 As String, ByVal vrow As Integer)
        If threadEnabled = True Then
            If grdpallets.InvokeRequired Then
                grdpallets.BeginInvoke(New AddcountDelegate(AddressOf AddDGVcount), v0, v1, vrow)
            Else
                grdpallets.Rows(vrow).Cells(6).Value = v0
                grdpallets.Rows(vrow).Cells(13).Value = v1
            End If
        End If
    End Sub
    ...
    Public Sub searchpallet()
        Try
            ...
            sql = "Select tbllogticket.palletnum, tbllogticket.qadispo, tbllogticket.status, tbllogitem.status as itemstatus, tbllogticket.status as ticketstatus from tbllogitem"
            sql = sql & " INNER JOIN tbllogticket on tbllogitem.logitemid=tbllogticket.logitemid"
            sql = sql & " where tbllogticket.palletnum='" & Trim(txtpallet.Text) & "' and tbllogitem.itemname='" & orderfill.cmbitem.Text & "' and tbllogticket.branch='" & login.branch & "'"
            ...
            sql = sql & " where tbllogsheet.status<>'3' and tbllogsheet.branch='" & login.branch & "'"
            sql = sql & " and tbllogticket.qadispo='1' and tbllogitem.itemname='" & orderfill.cmbitem.Text & "' and tbllogticket.status='1' and tbllogitem.status='2' and tbllogticket.palletnum='" & Trim(txtpallet.Text) & "'"
    ...
    Public Sub searchticket()
        Try
            ...
            sql = "Select tbllogticket.ticketwhse, tbllogticket.qadispo, tbllogticket.palletnum, tbllogitem.itemname, tbllogticket.status as ticketstatus, tbllogticket.location, tbllogitem.status as itemstatus from tbllogitem"
            sql = sql & " inner join tbllogticket on tbllogitem.logitemid=tbllogticket.logitemid"
            sql = sql & " right outer join tblloggood on tbllogticket.logticketid=tblloggood.logticketid"
            sql = sql & " where ((tblloggood.letter='" & Trim(txtletter.Text) & "' and tblloggood.gticketnum='" & Trim(txtticket.Text) & "' and tblloggood.status<>'3' and tblloggood.branch='" & login.branch & "'))"
            sql = sql & " and tbllogitem.itemname='" & orderfill.cmbitem.Text & "' and tbllogitem.status='2' and tbllogticket.status<>'3' and tbllogticket.branch='" & login.branch & "'"
            If Trim(cmbloc.Text) <> "" Then
                sql = sql & " and location='" & Trim(cmbloc.Text) & "'"
            End If
            ...
            sql = sql & "Select tbllogticket.ticketwhse, tbllogticket.qadispo, tbllogticket.palletnum, tbllogitem.itemname, tbllogticket.status as ticketstatus, tbllogticket.location, tbllogitem.status as itemstatus from tbllogitem"
            sql = sql & " inner join tbllogticket on tbllogitem.logitemid=tbllogticket.logitemid"
            sql = sql & " right outer join tbllogdouble on tbllogticket.logticketid=tbllogdouble.logticketid"
            sql = sql & " where ((tbllogdouble.letter='" & Trim(txtletter.Text) & "' and tbllogdouble.dticketnum='" & Trim(txtticket.Text) & "' and tbllogdouble.status<>'3' and tbllogdouble.branch='" & login.branch & "'))"
            sql = sql & " and tbllogitem.itemname='" & orderfill.cmbitem.Text & "' and tbllogitem.status='2' and tbllogticket.status<>'3' and tbllogticket.branch='" & login.branch & "'"
            If Trim(cmbloc.Text) <> "" Then
                sql = sql & " and location='" & Trim(cmbloc.Text) & "'"
            End If
            ...
            sql = sql & " inner join tbllogticket on tbllogitem.logitemid=tbllogticket.logitemid"
            sql = sql & " where tbllogsheet.status<>'3' and tbllogsheet.branch='" & login.branch & "'"
            sql = sql & " and tbllogticket.qadispo='1' and tbllogitem.itemname='" & orderfill.cmbitem.Text & "' and tbllogticket.status='1' and tbllogitem.status='2' and tbllogticket.palletnum='" & palnum & "'"
    ...
    Private Sub btnfirst_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnfirst.Click
        Try
            ...
            dr = cmd.ExecuteReader
            While dr.Read
                sql = "Select logsheetid from tblloggood where logsheetid='" & dr("logsheetid") & "' and status='1'"
                connect()
            ...
            '/sql = sql & " full outer join tblloggood on tbllogticket.logticketid=tblloggood.logticketid full outer join tbllogdouble on tbllogticket.logticketid=tbllogdouble.logticketid"
            sql = sql & " where tbllogticket.qadispo='1' and tbllogitem.itemname='" & orderfill.cmbitem.Text & "' and tbllogitem.status='2' and tbllogticket.status='1' and tbllogsheet.status<>'3'"
            sql = sql & " and tbllogsheet.logsheetid='" & firstlogsheetid & "' and tbllogticket.branch='" & login.branch & "' order by tbllogticket.palletnum"
            '/sql = "Select * from tbllogticket left outer join tbllogitem on tbllogitem.logitemid=tbllogticket.logitemid where tbllogticket.qadispo='1' and tbllogticket.ticketwhse='" & lblwhse.Text & "'  and tbllogitem.itemname='" & orderfill.cmbitem.Text & "'"
