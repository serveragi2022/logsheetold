...
Public Class reclogsheet
    ...
    Private Sub rec_searchlogs()
        Try
            ...
            If Trim(txtwrs.Text) <> "" Then
                sql = "Select tbllogsheet.allitems, tbllogsheet.logsheetid, tbllogsheet.logsheetdate, tbllogsheet.logsheetnum, tbllogsheet.whsename, tbllogsheet.palletizer, tbllogsheet.shift,"
                sql = sql & " tbllogitem.itemname, tbllogsheet.thread, tbllogsheet.bagtype, tbllogsheet.printtype, tbllogsheet.binnum, tbllogsheet.prodrems,  tbllogsheet.qcarems, tbllogsheet.millersup, tbllogsheet.datecreated,"
                sql = sql & " tbllogsheet.createdby, tbllogsheet.datemodified, tbllogsheet.modifiedby, tbllogsheet.status, tbllogsheet.remarks, tbllogsheet.canceldate, tbllogsheet.cancelby, tbllogsheet.cancelreason"
                sql = sql & " from tbllogsheet INNER JOIN tbllogitem ON tbllogsheet.logsheetid=tbllogitem.logsheetid"
                sql = sql & " INNER JOIN tblrecof ON tbllogsheet.recnum=tblrecof.recnum"
                sql = sql & " where tbllogsheet.branch='" & login.branch & "' and tbllogsheet.printtype" & rb & "'Receive' and tblrecof.wrsnum='" & Trim(txtwrs.Text) & "'"

            ElseIf Trim(txtofnum.Text) <> "" Then
                sql = "Select tbllogsheet.allitems, tbllogsheet.logsheetid, tbllogsheet.logsheetdate, tbllogsheet.logsheetnum, tbllogsheet.whsename, tbllogsheet.palletizer, tbllogsheet.shift,"
                sql = sql & " tbllogitem.itemname, tbllogsheet.thread, tbllogsheet.bagtype, tbllogsheet.printtype, tbllogsheet.binnum, tbllogsheet.prodrems,  tbllogsheet.qcarems, tbllogsheet.millersup, tbllogsheet.datecreated,"
                sql = sql & " tbllogsheet.createdby, tbllogsheet.datemodified, tbllogsheet.modifiedby, tbllogsheet.status, tbllogsheet.remarks, tbllogsheet.canceldate, tbllogsheet.cancelby, tbllogsheet.cancelreason"
                sql = sql & " from tbllogsheet INNER JOIN tbllogitem ON tbllogsheet.logsheetid=tbllogitem.logsheetid"
                sql = sql & " INNER JOIN tblrecof ON tbllogsheet.recnum=tblrecof.recnum"
                sql = sql & " where tbllogsheet.branch='" & login.branch & "' and tbllogsheet.printtype" & rb & "'Receive' and tblrecof.ofnum='" & lblof.Text & txtofnum.Text & "'"

            ElseIf Trim(txtrecid.Text) <> "" Then
                sql = "Select tbllogsheet.allitems, tbllogsheet.logsheetid, tbllogsheet.logsheetdate, tbllogsheet.logsheetnum, tbllogsheet.whsename, tbllogsheet.palletizer, tbllogsheet.shift,"
                sql = sql & " tbllogitem.itemname, tbllogsheet.thread, tbllogsheet.bagtype, tbllogsheet.printtype, tbllogsheet.binnum, tbllogsheet.prodrems,  tbllogsheet.qcarems, tbllogsheet.millersup, tbllogsheet.datecreated,"
                sql = sql & " tbllogsheet.createdby, tbllogsheet.datemodified, tbllogsheet.modifiedby, tbllogsheet.status, tbllogsheet.remarks, tbllogsheet.canceldate, tbllogsheet.cancelby, tbllogsheet.cancelreason"
                sql = sql & " from tbllogsheet INNER JOIN tbllogitem ON tbllogsheet.logsheetid=tbllogitem.logsheetid"
                sql = sql & " INNER JOIN tblreceive ON tbllogsheet.recnum=tblreceive.recnum"
                sql = sql & " where tbllogsheet.branch='" & login.branch & "' and tbllogsheet.printtype" & rb & "'Receive' and tblreceive.recid='" & Trim(txtrecid.Text) & "'"

            ElseIf Trim(txtrecnum.Text) <> "" Then
                sql = "Select tbllogsheet.allitems, tbllogsheet.logsheetid, tbllogsheet.logsheetdate, tbllogsheet.logsheetnum, tbllogsheet.whsename, tbllogsheet.palletizer, tbllogsheet.shift,"
                sql = sql & " tbllogitem.itemname, tbllogsheet.thread, tbllogsheet.bagtype, tbllogsheet.printtype, tbllogsheet.binnum, tbllogsheet.prodrems,  tbllogsheet.qcarems, tbllogsheet.millersup, tbllogsheet.datecreated,"
                sql = sql & " tbllogsheet.createdby, tbllogsheet.datemodified, tbllogsheet.modifiedby, tbllogsheet.status, tbllogsheet.remarks, tbllogsheet.canceldate, tbllogsheet.cancelby, tbllogsheet.cancelreason"
                sql = sql & " from tbllogsheet INNER JOIN tbllogitem ON tbllogsheet.logsheetid=tbllogitem.logsheetid"
                sql = sql & " INNER JOIN tblreceive ON tbllogsheet.recnum=tblreceive.recnum"
                sql = sql & " where tbllogsheet.branch='" & login.branch & "' and tbllogsheet.printtype" & rb & "'Receive' and tblreceive.recnum='" & lblrec.Text & Trim(txtrecnum.Text) & "'"
            ...
            sql = sql & " GROUP BY tbllogsheet.allitems,tbllogsheet.logsheetid, tbllogsheet.logsheetdate, tbllogsheet.logsheetnum, tbllogsheet.whsename, tbllogsheet.palletizer, tbllogsheet.shift,"
            sql = sql & " tbllogitem.itemname, tbllogsheet.thread, tbllogsheet.bagtype, tbllogsheet.printtype, tbllogsheet.binnum, tbllogsheet.prodrems,  tbllogsheet.qcarems, tbllogsheet.millersup, tbllogsheet.datecreated,"
            sql = sql & " tbllogsheet.createdby, tbllogsheet.datemodified, tbllogsheet.modifiedby, tbllogsheet.status, tbllogsheet.remarks, tbllogsheet.canceldate, tbllogsheet.cancelby, tbllogsheet.cancelreason"
            sql = sql & " order by tbllogsheet.logsheetid"
            ...
            If grdlog.SelectedCells.Count = 1 Or grdlog.SelectedRows.Count = 1 Then
                ...
                If okallitems = True Then
                    ...
                    If adlogcnf = True Then
                        ...
                        sql = "Update tbllogitem set status='0' where logsheetid='" & grdlog.Rows(selectedrow).Cells(0).Value & "' and status='2'"
                        connect()
                        cmd = New SqlCommand(sql, conn)
                        cmd.ExecuteNonQuery()
                        cmd.Dispose()
    ...
    Private Sub btnrecviewall_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnrecviewall.Click
        rec_viewpending()
    End Sub
    ...
    Private Sub CancelToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CancelToolStripMenuItem.Click
        Try
            ...
            If grdrec.SelectedCells.Count = 1 Or grdrec.SelectedRows.Count = 1 Then
                ...
                dr = cmd.ExecuteReader
                If dr.Read Then
                    MsgBox("Receive# " & grdrec.Rows(rec_selectedrow).Cells(2).Value & " is already cancelled.", MsgBoxStyle.Exclamation, "")
                    Exit Sub
                End If
                dr.Dispose()
                cmd.Dispose()
                ...
                'check if logsheet is not cancelled
                sql = "Select status from tbllogsheet where recnum='" & grdrec.Rows(rec_selectedrow).Cells(2).Value & "' and allitems='1'"
                connect()
                cmd = New SqlCommand(sql, conn)
                dr = cmd.ExecuteReader
                If dr.Read Then
    ...
    Private Sub btnrecsearch_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnrecsearch.Click
        Try
            ...
            If Trim(txtrecid.Text) <> "" Then
                sql = "Select tblreceive.* from tblreceive where tblreceive.branch='" & login.branch & "'"
                sql = sql & " and tblreceive.recid='" & Trim(txtrecid.Text) & "'"

                If chkrechide.Checked = True Then
                    sql = sql & " and tblreceive.status<>'3'"
                End If

            ElseIf Trim(txtrecnum.Text) <> "" Then
                 sql = "Select tblreceive.* from tblreceive where tblreceive.branch='" & login.branch & "'"
                sql = sql & " and tblreceive.recnum='" & lblrec.Text & Trim(txtrecnum.Text) & "'"
            ...
            ElseIf Trim(txtwrs.Text) <> "" Then
                sql = "Select tblreceive.recid, tblreceive.recdate, tblreceive.recnum, tblreceive.frmbranch, tblreceive.remarks, tblreceive.datecreated, tblreceive.createdby,"
                sql = sql & " tblreceive.datemodified, tblreceive.modifiedby, tblreceive.status, tblreceive.datecancelled, tblreceive.cancelledby, tblreceive.creason"
                sql = sql & " from tblreceive INNER JOIN tblrecof ON tblreceive.recnum=tblrecof.recnum"
                sql = sql & " where tblreceive.branch='" & login.branch & "'"
                sql = sql & " and tblrecof.wrsnum='" & Trim(txtwrs.Text) & "'"

                If chkrechide.Checked = True Then
                    sql = sql & " and tblreceive.status<>'3'"
                End If

                sql = sql & " GROUP BY tblreceive.recid, tblreceive.recdate, tblreceive.recnum, tblreceive.frmbranch, tblreceive.remarks, tblreceive.datecreated, tblreceive.createdby,"
                sql = sql & " tblreceive.datemodified, tblreceive.modifiedby, tblreceive.status, tblreceive.datecancelled, tblreceive.cancelledby, tblreceive.creason"
            ...
            ElseIf Trim(txtofnum.Text) <> "" Then
                ...
                sql = sql & " from tblreceive INNER JOIN tblrecof ON tblreceive.recnum=tblrecof.recnum"
                sql = sql & " where tblreceive.branch='" & login.branch & "'"
                sql = sql & " and tblrecof.ofnum='" & lblof.Text & Trim(txtofnum.Text) & "'"
            ...
            Else
                sql = "Select tblreceive.* from tblreceive where tblreceive.branch='" & login.branch & "'"
                sql = sql & " and tblreceive.recdate>='" & Format(recdfrom.Value, "yyyy/MM/dd") & "' and tblreceive.recdate<='" & Format(recdto.Value, "yyyy/MM/dd") & "'"
            ...
            sql = sql & " order by tblreceive.recid"
    ...
    Private Sub grdrec_RowPrePaint(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewRowPrePaintEventArgs) Handles grdrec.RowPrePaint
        If e.RowIndex > -1 Then
            ...
            '<== But this is the name assigned to it in the properties of the control
            If dgvRow.Cells(9).Value = "Cancelled" Then 'step1
                dgvRow.DefaultCellStyle.BackColor = Color.DeepSkyBlue
            End If
        End If
    End Sub
    ...
    Private Sub txtrecid_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtrecid.TextChanged
        Dim charactersDisallowed As String = "0123456789"
        Dim theText As String = txtrecid.Text
        Dim Letter As String
        Dim SelectionIndex As Integer = txtrecid.SelectionStart
        Dim Change As Integer

        For x As Integer = 0 To txtrecid.Text.Length - 1
            Letter = txtrecid.Text.Substring(x, 1)
            If Not charactersDisallowed.Contains(Letter) Then
                theText = theText.Replace(Letter, String.Empty)
                Change = 1
            End If
        ...
        txtrecid.Text = theText
        txtrecid.Select(SelectionIndex - Change, 0)


        If Trim(txtrecid.Text) <> "" Then
            'false
            recdfrom.Enabled = False
            recdto.Enabled = False
            txtrecnum.Enabled = False
            txtwrs.Enabled = False
            txtofnum.Enabled = False
        Else
            'true
            recdfrom.Enabled = True
            recdto.Enabled = True
            txtrecnum.Enabled = True
            txtwrs.Enabled = True
    ...
    Private Sub txtrecnum_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles txtrecnum.KeyPress
        If Asc(e.KeyChar) = 39 Then
            e.Handled = True
        ElseIf Asc(e.KeyChar) = Windows.Forms.Keys.Enter Then
            '/tripsearch()
    ...
    Private Sub txtrecnum_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtrecnum.TextChanged
        If Trim(txtrecnum.Text) <> "" Then
            recdfrom.Enabled = False
            recdto.Enabled = False
            txtofnum.Enabled = False
            txtrecid.Enabled = False
    ...
    Private Sub ViewAllLogSheetToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ViewAllLogSheetToolStripMenuItem.Click
